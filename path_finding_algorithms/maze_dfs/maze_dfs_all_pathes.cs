...
namespace algos
{
    class Program
    {
        ...
        public static List<Point[]> pathes = new List<Point[]>();
        ...
        /// </summary>
        static void Solve(Point start, Point end, List<Point> path)
        {
        ...
        static void Draw(Point[] path = null)
        {
